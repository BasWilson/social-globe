    ...
    <div class="container">
        <div class="row">
            ...
            <div id="profile-container" class="col-md-12">
                <div class="profile-card" style="color: white"">
                    <p>Your email has not been verified yet, you can only use the globe if you verify your account.</p>
                    <a id="resend-text" style="cursor: pointer" onclick="ResendVerificationEmail()"">Click to resend verification email</a>
                </div>
            </div>
        </div>
    </div>
