...
<head>
    ...
    <title>Reset password - Social Globe</title>
...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div id="reset-container" class="col-md-12">
                    <div class="login-clean">
                        <form style="text-align: center">
                            <h3 style="margin-bottom: 20px;" >Reset password</h3>
                            <div class="form-group"><input class="form-control" type="username" id="resetUsernameField" placeholder="Username"></div>
                            <div class="form-group"><input class="form-control" type="password" id="resetPasswordField" placeholder="New password"></div>
                            <div class="form-group"><a class="modalbutton" style="color:white; cursor:pointer;" onclick="ResetPassword('reset')">Reset Password</a></div>
                        </form>
                    </div>
            </div>
        </div>
    ...
    <script>ResetPassword('verify')</script>
</body>
