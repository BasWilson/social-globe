  ...
  <div class="profile-card">
    ...
    <div class="profile-edit-change">
        <label>First Name</label><br>
          <input type="text" class="form-control" id="first_name" value=" '.$_SESSION['first_name'].'" readonly> <br>
        <label>Last Name</label><br>
          <input type="text" class="form-control" id="last_name" value=" '.$_SESSION['last_name'].'" readonly> <br>
